      ...
      <PageContainer>
        ...
        <div className="max-w-5xl">
          ...
          <PageHeader
            ...
            description="Create, structure, launch and operate a complete AI-powered company through a single intelligent operating system."
          />
          ...
          <div className="mt-20 grid gap-10 md:grid-cols-3">
            ...
            <div>
              <p className="text-4xl font-semibold">1 Platform</p>
              <span className="text-sm text-zinc-500">
